    ...
    <div>
      <section className="w-full px-4 py-24 mx-auto max-w-7xl md:w-3/4 lg:w-2/4">
        <div className="flex flex-col ">
          ...
          <div className="flex flex-col">
            <a href="tel:+233555190488" className="mb-2 text-base font-normal text-gray-600">
              +233555190488
            </a>
            <a href="tel:+233200438498" className="mb-2 text-base font-normal text-gray-600">
              +233200438498
            </a>
            <a
            ...
            <p className="mt-2 text-base font-normal text-gray-600">
              WhatsApp chat:{" "}
              <a className="underline" href="https://wa.me/message/NRDZZQVYGWMCL1">
