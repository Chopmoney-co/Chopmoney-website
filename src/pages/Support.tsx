    ...
    <div>
      <section className="w-full px-4 py-24 mx-auto max-w-7xl md:w-3/4 lg:w-2/4">
        ...
        <div className="flex flex-col ">
          <div>
            <h1 className="mb-2 text-xl font-bold text-center leading-snug text-center tracking-tight text-gray-800 md:text-5xl">
              Support
            </h1>
            <p className="my-8 text-base font-normal text-center text-gray-600">
          ...
          <div className="flex flex-col">
            <a
              ...
              className="mb-2 text-base font-normal text-center text-gray-600"
            >
              +233555190488
            </a>
            <a
            ...
            <a
              ...
              className="mb-4 text-base font-normal text-center text-gray-600"
            >
              admin@chopmoney.co
            </a>
