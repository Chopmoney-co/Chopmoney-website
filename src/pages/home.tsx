            ...
            <div id="forms" className="minifab op5">
              ...
              >
                <svg
                  ...
                  width="43.865"
                  height="43.865"
                  viewBox="0 0 43.865 43.865"
                >
                  <g
                    id="Group_2229"
                    data-name="Group 2229"
                    transform="translate(-203.773 -8.068)"
                  >
                    <path
                      id="Path_36"
                      data-name="Path 36"
                      d="M43.865,23.432A20.432,20.432,0,1,1,23.432,3,20.432,20.432,0,0,1,43.865,23.432Z"
                      transform="translate(202.273 6.568)"
                      fill="#1d1d0c"
                      stroke="#ecec0b"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    ...
                    <path
                      ...
                      d="M11.077.016C12.119,0,13.152.008,14.186,0a4.953,4.953,0,0,0,1.392,3.316A5.608,5.608,0,0,0,18.95,4.739v3.2a8.512,8.512,0,0,1-3.34-.771,9.825,9.825,0,0,1-1.288-.74c-.008,2.322.008,4.644-.016,6.958a6.074,6.074,0,0,1-1.074,3.133,5.925,5.925,0,0,1-4.7,2.553,5.8,5.8,0,0,1-3.244-.819,6,6,0,0,1-2.9-4.541c-.016-.4-.024-.8-.008-1.185A5.987,5.987,0,0,1,9.32,7.221c.016,1.177-.032,2.354-.032,3.531A2.728,2.728,0,0,0,5.8,12.437a3.155,3.155,0,0,0-.111,1.28A2.706,2.706,0,0,0,8.477,16a2.672,2.672,0,0,0,2.2-1.28,1.835,1.835,0,0,0,.326-.843c.08-1.423.048-2.839.056-4.262.008-3.2-.008-6.4.016-9.6Z"
                      transform="translate(215.047 20.458)"
                      fill="#ecec0b"
                    />
                  </g>
                </svg>
              ...
              >
                ...
                >
                  <g
                    ...
                    transform="translate(-154.773 -8.068)"
                  >
                    <path
                      id="Path_34"
                      data-name="Path 34"
                      d="M43.865,23.432A20.432,20.432,0,1,1,23.432,3,20.432,20.432,0,0,1,43.865,23.432Z"
                      transform="translate(153.273 6.568)"
                      fill="#1d1d0c"
                      stroke="#ecec0b"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    ...
                    <path
                      ...
                      d="M24.9,4.5a11.593,11.593,0,0,1-3.34,1.627A4.765,4.765,0,0,0,13.2,9.313v1.064A11.337,11.337,0,0,1,3.627,5.559S-.627,15.131,8.945,19.385A12.38,12.38,0,0,1,1.5,21.512c9.572,5.318,21.271,0,21.271-12.231a4.786,4.786,0,0,0-.085-.883A8.211,8.211,0,0,0,24.9,4.5Z"
                      transform="translate(163.507 15.973)"
                      fill="#1d1d0c"
                      stroke="#ecec0b"
                      stroke-linecap="round"
                      stroke-linejoin="round"
              ...
              >
                ...
                >
                  <g
                    ...
                    transform="translate(-106.068 -8.068)"
                  >
                    <path
                      id="Path_32"
                      data-name="Path 32"
                      d="M43.865,23.432A20.432,20.432,0,1,1,23.432,3,20.432,20.432,0,0,1,43.865,23.432Z"
                      transform="translate(104.568 6.568)"
                      fill="#1d1d0c"
                      stroke="#ecec0b"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    ...
                    <path
                      ...
                      d="M21,3H18.134a4.771,4.771,0,0,0-4.771,4.771v2.863H10.5v3.817h2.863v7.634H17.18V14.451h2.863L21,10.634H17.18V7.771a.954.954,0,0,1,.954-.954H21Z"
                      transform="translate(112.252 17.458)"
                      fill="#ecec0b"
                    />
                  </g>
                </svg>
              ...
              >
                ...
                >
                  <g
                    ...
                    transform="translate(-57.068 -8.068)"
                  >
                    <path
                      id="Path_28"
                      data-name="Path 28"
                      d="M43.865,23.432A20.432,20.432,0,1,1,23.432,3,20.432,20.432,0,0,1,43.865,23.432Z"
                      transform="translate(55.568 6.568)"
                      fill="#1d1d0c"
                      stroke="#ecec0b"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    ...
                    <g
                      ...
                      transform="translate(66.458 17.458)"
                    >
                      <path
                        id="Path_29"
                        data-name="Path 29"
                        d="M7.771,3h9.542a4.771,4.771,0,0,1,4.771,4.771v9.542a4.771,4.771,0,0,1-4.771,4.771H7.771A4.771,4.771,0,0,1,3,17.314V7.771A4.771,4.771,0,0,1,7.771,3Z"
                        fill="#1d1d0c"
                        stroke="#ecec0b"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                      ...
                      <path
                        id="Path_30"
                        data-name="Path 30"
                        d="M19.657,15.192a3.817,3.817,0,1,1-3.216-3.216,3.817,3.817,0,0,1,3.216,3.216Z"
                        transform="translate(-3.298 -3.251)"
                        fill="#1d1d0c"
                        stroke="#ecec0b"
                        stroke-linecap="round"
                        stroke-linejoin="round"
                      ...
                      <path
                        ...
                        data-name="Path 31"
                        d="M26.25,9.75h0"
                        transform="translate(-8.459 -2.456)"
                        fill="#1d1d0c"
                        stroke="#ecec0b"
                        stroke-linecap="round"
                        stroke-linejoin="round"
              ...
              <a href="mailto:admin@chopmoney.co">
                ...
                >
                  <g
                    ...
                    transform="translate(-8.068 -8.068)"
                  >
                    <path
                      id="Path_23"
                      data-name="Path 23"
                    ...
                    <g
                      ...
                      transform="translate(20.407 22.326)"
                    >
                      <path
                        id="Path_26"
                        data-name="Path 26"
                        d="M4.919,6H20.267a1.924,1.924,0,0,1,1.919,1.919V19.43a1.924,1.924,0,0,1-1.919,1.919H4.919A1.924,1.924,0,0,1,3,19.43V7.919A1.924,1.924,0,0,1,4.919,6Z"
                      ...
                      <path
                        id="Path_27"
                        data-name="Path 27"
                        d="M22.186,9l-9.593,6.715L3,9"
                        transform="translate(-3 -7.081)"
                        fill="#1d1d0c"
                        stroke="#ecec0b"
                        stroke-linecap="round"
                        stroke-linejoin="round"
