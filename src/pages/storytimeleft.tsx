          ...
          <div className="container mx-auto flex flex-col items-center px-4 py-16 text-center md:py-32 md:px-10 lg:px-32 2xl:p-0 xl:max-w-4xl">
            ...
            <p className="my-2 sm:my-4 text-sm text-[#0D0D0D] 2xl:text-base">
              ...
              <span className="font-bold">
                daily or weekly stipend (pocket money){" "}
              </span>{" "}
            ...
            <div className="flex flex-row flex-wrap justify-center">
              <a href="https://apps.apple.com/app/chopmoney/id6444722445" className="px-8 py-4 m-2 text-xs font-semibold rounded bg-[#0D0D0D] text-[#ECEC08] hover:scale-110 duration-300 transform">
                Apple Store
